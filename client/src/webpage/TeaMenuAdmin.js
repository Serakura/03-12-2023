                ...
                <tr key={val.id}>
                  ...
                  <td>
                    <td className="d-flex justify-content-start">
                      {val.img1 && <img src={val.img1} alt="Food1" style={{ width: "42px" }} />}
                      {val.img2 && <img src={val.img2} alt="Food2" className="ms-1" style={{ width: "42px" }} />}
                      {val.img3 && <img src={val.img3} alt="Food3" className="ms-1" style={{ width: "42px" }} />}
                    </td>
                  </td>
                  <td>{val.highlight}</td>
                  <td>
